...
J_intermediatepoint1 = [-55.81, -78.14, -94.88, -100.47, 80.93, -2.79]
J_intermediatepoint2 = [-113.370000, -85.520000, -131.270000, -145.190000, -23.870000, -217.450000]
...
T_vos = rm.Mat(UR_T_TCP_vos.tolist())
T_hos = rm.Mat(UR_T_TCP_hos.tolist())
T_vout = rm.Mat(UR_T_TCP_vout.tolist())

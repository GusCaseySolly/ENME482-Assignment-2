...
J_intermediatepoint_2 = [-7.960000, -99.450000, -133.260000, -125.470000, -35.180000, 139.550000]
...
#Stls.rancilio_tool_attach_l_ati()
...
UR5.MoveL(J_intermediatepoint_1, blocking=True)
#time.sleep(1)
#UR5.MoveJ(J_intermediatepoint_2, blocking=True)
#UR5.MoveJ(J_intermediatepoint_1, blocking=True)
# go back home
